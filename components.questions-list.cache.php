...
document.querySelectorAll('.question-paragraph').forEach(paragraph => {
    ...
    paragraph.addEventListener('click', function() {
        ...
        if (questionPopup) {
            ...
            questionPopup.setAttribute('data-source', JSON.stringify(questionData));
            if (typeof window.updateQuestionPopup === 'function') {
                window.updateQuestionPopup(questionData);
            }
        }
    });
});
